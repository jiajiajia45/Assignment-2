...
def function7():
    ...
    return np.zeros_like(x), x.dtype#write your code here
...
def function16(): 
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans =ans = np.concatenate((x,y),axis = 1)  #write your code here 
...
def fucntion20():
   ...
   z = np.apply_along_axis(abc, 0, x)  #Write your Code here
   return z
